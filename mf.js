...
spans.forEach(span => {
  ...
  function highlightRows() {
      ...
      rows.forEach(row => {
          ...
          if (clientStatus === 'Déposée' || orderStatus === 'Déposée' || type === 'Immédiate') {
              row.style.backgroundColor = '#42ff79';
          } else if (clientStatus === 'En attente de paiement' || orderStatus === 'En recherche' || type === 'Immédiate') {
              row.style.backgroundColor = '#ffeb42';
          } else if (clientStatus === 'En préparation' || orderStatus === 'En recherche' || type === 'Immédiate') {
              row.style.backgroundColor = '#ffeb42';
          } else if (clientStatus === 'Acceptée' || orderStatus === 'En recherche' || type === 'Immédiate') {
              row.style.backgroundColor = '#e7e6e6';
          } else if (clientStatus === 'Acceptée' || orderStatus === 'Acceptée' || type === 'Immédiate') {
              row.style.backgroundColor = '#ffeb42';
          } else if (clientStatus === 'Livreur en route' || orderStatus === 'Récupérée' || type === 'Immédiate') {
              row.style.backgroundColor = '#5b9bd5';
          } else if (clientStatus === 'Récupérée' || orderStatus === 'Récupérée' || type === 'Immédiate') {
              row.style.backgroundColor = '#5b9bd5';
          } else if (clientStatus === 'Prête' || orderStatus === 'Acceptée' || type === 'Immédiate') {
              row.style.backgroundColor = '#5b9bd5';
          } else if (clientStatus === 'Annulée' || orderStatus === 'Annulée' || type === 'Immédiate') {
              row.style.backgroundColor = '#ff4242';
          } else if (clientStatus === 'Expirée' || orderStatus === 'Expirée' || type === 'Immédiate') {
              row.style.backgroundColor = '#ff4242';
          }
      });
  }
