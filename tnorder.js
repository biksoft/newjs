...
function initializeUI() {
    ...
    // Inject CSS for the new collapsible panel
    const styles = `
...
function extractOrderId(){const e=document.querySelector(ORDER_ID_SOURCE_SELECTOR);if(!e)return null;const t=e.href.split("/orders/");if(t.length<2)return null;const o=t[1].split("/")[0];return o&&24===o.length?o:null}
...
console.log("✅ Livry Super Toolkit (Fixed & Collapsible) is running...");
